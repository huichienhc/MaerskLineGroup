...
namespace MaerskLineGroup.Controllers
{
    ...
    public class ContainersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ContainerID,ContainerName,ContainerWeight")] Container container)
        {
        ...
        public ActionResult Edit([Bind(Include = "ContainerID,ContainerName,ContainerWeight")] Container container)
        {
            if (ModelState.IsValid)
            {
